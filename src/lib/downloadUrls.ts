...
export const DESKTOP_CONNECTOR_HARDCODED_DOWNLOADS: {
  ...
  mac_arm64:
    "https://github.com/7Socialapps/mlt-desktop-connector/releases/download/v1.1.1/MLT.Desktop.Connector_1.1.1_aarch64.dmg",
  mac_x64:
    "https://github.com/7Socialapps/mlt-desktop-connector/releases/download/v1.1.1/MLT.Desktop.Connector_1.1.1_x64.dmg",
  windows_x64: null,
};
